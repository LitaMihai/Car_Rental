...
EmailVerificationState::EmailVerificationState(sf::RenderWindow* window, std::stack<State*>* states, DbConnection* accountDataBase, std::string* emailString, std::string* password) : State(window, states), code(code), continueRegistration(continueRegistration), emailString(*emailString), password(*password), accountDataBase(accountDataBase)
{
	this->initVariables();
	this->initBackground();
	this->initFonts();
